...
?>
    <div id="container_admin" class="mt-5 container-fluid">
        <div id="accueil_admin" class="row col-lg-10">
           ...
           <p><strong> COMMENTAIRES :</strong> dans cette section il vous sera possible de voir tous les commentaires laissés sur vos articles. Ils sont classés pas nombre(s) de signalement(s) afin de faciliter leur modération. Vous pourrez ainsi supprimer un commentaire où remettre à 0 le nombre de signalements.</p>
